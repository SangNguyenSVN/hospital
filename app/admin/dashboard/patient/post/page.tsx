...
const CreatePatientPage: React.FC = () => {
  ...
  const [errors, setErrors] = useState<Partial<Record<keyof NewPatientData, string>>>({});
  ...
  const validateInputs = () => {
    const newErrors: Partial<Record<keyof NewPatientData, string>> = {};
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Tạo Mới Bệnh Nhân</h1>
